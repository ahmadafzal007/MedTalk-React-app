        ...
        <div className="grid md:grid-cols-5 gap-10">
          <div className="flex justify-center md:col-span-2">
            <div className="max-w-xs">
              <h2 className=" text-[90px] ml-[10px] md:ml-0 font-permanent font-bold text-white  leading-tight">
                FAQ!
              </h2>
              <div>
            ...
            <div className="hs-accordion-group divide-y divide-gray-600">
              {faqs.map((faq, index) => (
                ...
                >
                  ...
                  >
                    <p className="text-white text-base font-inconsolata text-start">{faq.answer}</p>
                  </div>
                </div>
              ))}
            </div>
