...
function Card() {
  ...
  <div className='h-screen w-full bg-black text-white fixed  mt-[89px] overflow-hidden'>
...
<div className=" bg-black flex items-center justify-center  py-12 overflow-hidden ">
  ...
  className="group relative cursor-pointer items-center justify-center overflow-hidden transition-shadow hover:shadow-xl hover:shadow-black/30 mr-20">
      ...
      <div className="absolute inset-0 flex translate-y-[60%] flex-col items-center justify-center px-9 text-center transition-all duration-500 group-hover:translate-y-0">
        ...
        <p className="mb-6 text-lg italic text-white opacity-0 transition-opacity duration-300 group-hover:opacity-100">Lorem ipsum dolor sit amet consectetur adipisicing elit. Facilis dolore adipisci placeat.</p>
        
        <Link to={"/login/Hospital"}>
        <button className="rounded-full bg-neutral-900 py-2 px-3 text-sm capitalize text-white shadow shadow-black/60 mb-2">Sign In</button> {/* Adjusted padding and font size */}
        </Link>

        <Link to={"/hospitalSignUp"}>
        <button className="rounded-full bg-neutral-900 py-2 px-3 text-sm capitalize text-white shadow shadow-black/60">Sign Up</button> {/* Adjusted padding and font size */}
        </Link>
      </div>
    </motion.div>
