    ...
    <div className="w-full fixed top-0 text-white py-7 flex justify-between items-center border-b-[1px] border-b-white-800 z-50">
     <div className="flex items-center">
      ...
      <div>
        ...
        <li>
  <button
    className="hover:border-white hidden border-1 font-light md:block p-2 text-lg font-poppins text-white-900 transition-all duration-300 ease-in-out transform hover:bg-black hover:text-white hover:scale-105 hover:shadow-lg"
  >
    Try MedTalk Pro
  </button>
</li>
