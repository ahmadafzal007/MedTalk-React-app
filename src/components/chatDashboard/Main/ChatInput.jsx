...
const ChatInput = ({ prompt, setPrompt, handleSendPrompt, isGenerating, setShowPDFForm }) => {
  ...
  return (
    <div className='absolute mb-8 font-poppins md:pb-0 md:mb-0 bottom-0 left-0 flex flex-col items-center bg-black right-0 mx-auto max-w-screen px-4 py-0 md:px-6 md:py-4 backdrop-blur-sm'>
