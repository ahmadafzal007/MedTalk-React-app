...
import HospitalDashboardForm from './components/Hospital/HospitalDashboard';
  ...
  return (
    <Router>
      <Routes>
        ...
        <Route path="/login/Hospital" element={<LoginForm role={"hospitalAdmin"}/> } />
        <Route path="/login/Doctor" element={<LoginForm role={"healthcareProfessional"}/> } />
        <Route path="/hospitalDB" element={<HospitalDashboardForm/>} />
